...
public class TokenConsumerProcessorTest extends JoseTestSupport {
    ...
    public void canConsume() throws Exception {
        ...
        exchange.getIn().setHeader(JwtHeaderConstants.JWT, getToken(keyPair));
    ...
    private String getToken(KeyPair keyPair) throws Exception {
        DefaultExchange exchange = new DefaultExchange(new DefaultCamelContext());
